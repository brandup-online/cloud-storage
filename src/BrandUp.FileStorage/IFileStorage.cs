namespace BrandUp.FileStorage
{
    public interface IFileStorage<TMetadata> : IDisposable where TMetadata : class, new()
    {
        ...
        Task<FileInfo<TMetadata>> UploadFileAsync(Guid fileId, Stream fileStream, CancellationToken cancellationToken = default);
        Task<FileInfo<TMetadata>> UploadFileAsync(Stream fileStream, CancellationToken cancellationToken = default);
